...
public class SpatialAnchorController : MonoBehaviour, IMixedRealityInputActionHandler
{
	/// <summary>
	/// Anchor UI manager singleton instance
	/// </summary>
	public static SpatialAnchorController Instance;
	...
	public Transform TrackedDevice { get
		{
			if (_trackedDevice) return _trackedDevice;
			_trackedDevice = PlayerOVR.Instance.transform.Find(RightHandLocation);
			return _trackedDevice;
		}
	}
	...
	private void Start()
	{
		_raycastOrigin = TrackedDevice;
		if (_menuParent) _menuParent.SetParent(_trackedDevice, false);
	...
	private const string _buttonA = "ButtonOnePress";
	...
	public void OnActionStarted(BaseInputEventData eventData)
	{
		...
		{
			_primaryPressDelegate?.Invoke();
			Debug.Log("Attempt Place Anchor");
		}
	}
